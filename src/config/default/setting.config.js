 ...
 * @LastEditTime: 2022-05-07 09:59:22
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \lottery-admin\src\config\default\setting.config.js
 */
...
module.exports = {
  ...
  copyright: "2021 cx", //copyright
  asyncRoutes: false, //异步加载路由，true:开启，false:不开启
  showPageTitle: true, //是否显示页面标题（PageLayout 布局中的页面标题），true:显示，false:不显示
  filterMenu: true, //根据权限过滤菜单，true:过滤，false:不过滤
  rechargeTips: true, //充值消息通知，true:开启，false:不开启
  withdrawalTips: true, //提现消息通知，true:开启，false:不开启
  bettingTips: false, //下注消息通知，true:开启，false:不开启
  tradeBetTips: false,//交易消息通知，true:开启，false:不开启
  animate: {
    //动画设置
